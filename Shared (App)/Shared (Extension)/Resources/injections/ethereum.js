    ...
    return new Promise((resolve, reject) => {
        ...
        switch (payload.method) {
            case 'eth_requestAccounts':
                console.info('received eth_requestAccounts');
                showPrompt();
                resolve(true);
                break;
            case 'eth_signTypedData_v3':
                console.info('received eth_signTypedData_v3');
                showPrompt();
                resolve(true);
                break;
            default:
                console.info('invalid or unimplemented method');
                resolve(false);
        }
    });
};
...
typeof window.ethereum !== 'undefined' && (console.info('window.ethereum is injected.'));
`
