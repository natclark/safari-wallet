...
//    func alchemyTokenAllowance(tokenContract: EthereumAddress,
...
//    }
    ...
    public func alchemyTokenBalances(address: String, tokenAddresses: [String]? = nil) async throws -> [AlchemyTokenBalance] {
